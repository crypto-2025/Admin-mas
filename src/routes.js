...
export const routes = [
  ...
  },
  {
    ...
    layout: HomeLayout,
    guard: true,
    component: lazy(() => import('src/views/pages/viewUsersTransaction')),
  },
  {
    exact: true,
    path: '/earnings',
    layout: HomeLayout,
    guard: true,
    component: lazy(() => import('src/views/pages/earnings')),
  },
  {
    exact: true,
    path: '/SearchResult',
  ...
  {
    exact: true,
    path: '/add-application-banner',
    guard: true,
    layout: HomeLayout,
    component: lazy(() =>
      import('src/views/pages/BannerApplication/newBanner')
    ),
  },
  {
    exact: true,
  ...
  {
    exact: true,
    path: '/edit-application-banner/:id',
    guard: true,
    layout: HomeLayout,
    component: lazy(() =>
      import('src/views/pages/BannerApplication/editBanner')
    ),
  },
  {
    exact: true,
...
{
    exact: true,
    path: '/view-application-banner/:id',
    guard: true,
    layout: HomeLayout,
    component: lazy(() =>
      import('src/views/pages/BannerApplication/viewBanner')
    ),
  },
  {
    exact: true,
