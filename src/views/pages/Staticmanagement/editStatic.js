        ...
        <Box mb={1}>
          <Box style={{ display: "flex", justifyContent: "space-between" }}>
            <Typography variant="h3" style={{ marginBottom: "8px" }}>
              <strong style={{ color:'#6345ED' }}> Edit Static</strong>
            </Typography>
            <Box style={{ textAlign: "end" }}>
              <Button onClick={() => setIsEdit(!isEdit)}>
                <Typography variant="h5" style={{ color:'#6345ED' }}>Edit </Typography>
                <EditIcon fontSize="small" style={{ marginLeft: "5px" ,color:'#6345ED' }} />
              </Button>
            </Box>
          </Box>
          <Divider />
