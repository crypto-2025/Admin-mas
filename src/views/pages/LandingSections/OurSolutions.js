...
const OurSolutions = () => {
    ...
    try {
      ...
      if (res.data.statusCode === 200) {
        ...
        if (res.data.result) {
          ...
          setimageurl(
            res.data.result?.contentFile ? res.data.result?.contentFile : ""
          );
          setbannerImage(
            res.data.result?.contentFile ? res.data.result?.contentFile : ""
          );
  ...
  return (
    <Container maxWidth="xl" style={{ marginTop: "12rem", minHeight: "88vh" }}>
                  ...
                  <Box mb={2}>
                    <Grid container spacing={0}>
                      ...
                      <Grid item xs={12} md={12}>
                        ...
                        {tooLongText && (
                          <FormHelperText error>
                            *To respect the landing page layout, enter a small
                            paragraph (less than 100 word)
                          </FormHelperText>
                        )}
