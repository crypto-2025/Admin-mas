  ...
  return (
    <Box className={classes.LoginBox}>
      <Container maxWidth="xl">
        <Box className={classes.filterBox} mb={5} mt={10}>
          <Typography variant="h6" style={{ color:'#6345ED' , fontSize:'2rem'}}>Filter :</Typography>
          ...
          <>
            ...
            <TableContainer className={classes.Paper} component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                ...
                >
                  <TableRow style={{  }}>
                    <TableCell align="Center" style={{ color: "white" ,background: "linear-gradient(0deg, #6345ED, #DC39FC)" }} >
                      Sr.No
                    </TableCell>
                    <TableCell align="Center" style={{ color: "white" ,background: "linear-gradient(0deg, #6345ED, #DC39FC)" }}>
                      Name
                ...
                <TableBody>
                  {details.map((row, index) => {
                    return <UserList row={row} key={index} index={index} blockUserHandler={blockUserHandler} deleteUserHandler={deleteUserHandler}/>;
                  })}
                </TableBody>
              </Table>
