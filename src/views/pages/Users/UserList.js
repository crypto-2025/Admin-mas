...
export default function UserList(props) {
  ...
  const { row, index, blockUserHandler, deleteUserHandler } = props;
  return (
    <TableRow className={classes.tbody} key={row.name}>
      ...
      <TableCell style={{ color: "black" }} align="Center">
        ...
        {parseFloat(row.fdusdBalance).toFixed(2)} FDUSD<br />
      ...
      <TableCell style={{ color: "black" }} align="Center">
        ...
        >
          ...
          <br />
            ...
            >
            {row.status == 'DELETE'? 'DELETE' : <DeleteRoundedIcon style={{ fontSize: "15px" }} />}
