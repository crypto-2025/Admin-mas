        ...
        <Container maxWidth="xl">
          <Box mb={5}>
            <Typography variant="h3" style={{ marginBottom: '8px' }}>
              <strong style={{ color:'#6345ED' }}> Static Content Management</strong>
            </Typography>
            <Divider />
          </Box>
            ...
            <TableContainer className={classes.Paper} component={Paper}>
              ...
              >
                <TableHead>
                  ...
                  >
                    <TableCell style={{ color: 'white' ,background: "linear-gradient(0deg, #6345ED, #DC39FC)"}}>Sr.No</TableCell>
                    <TableCell style={{ color: 'white' ,background: "linear-gradient(0deg, #6345ED, #DC39FC)"}} align="center">
                      Title
                    </TableCell>
                    {/* <TableCell
